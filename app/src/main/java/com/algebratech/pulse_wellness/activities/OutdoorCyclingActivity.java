...
public class OutdoorCyclingActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationManagerInterface, IBleWriteResponse {
...
//    ImageView camerarun;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoorcycling);
...
//                        mapimg.setImageBitmap(ImageUtil.convert(base64String));
        ...
        if (!isActive) {
            ...
            myEdit.putString("Activity Name", "Outdoor Cycling");
            ...
            new addActivityApi().endActivityApi(userId, timeTaken, String.valueOf(activityDistance), String.valueOf(activityKcals), avarageHeartRate, String.valueOf(activitySteps), avgPace, camera_file, today, "Outdoor Cycling",OutdoorCyclingActivity.this, new ActivityCallback() {
                @Override
                public void success() {
                    try {
                        CM.HideProgressLoader();
                        db.insertActivities("Outdoor Cycling", userId, timeTaken, activitySteps,
                        ...
                        intent.putExtra("activity", "Outdoor Cycling");
...
//        )
    ...
    private void getReadings() {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                VPOperateManager.getMangerInstance(OutdoorCyclingActivity.this).readSportModelState(OutdoorCyclingActivity.this, new ISportModelStateListener() {
                    @Override
                    public void onSportModelStateChange(SportModelStateData sportModelStateData) {
        ...
        VPOperateManager.getMangerInstance(this).confirmDevicePwd(writeResponse, new IPwdDataListener() {
            ...
            public void onFunctionSupportDataChange(FunctionDeviceSupportData functionSupport) {
                ...
                Log.e("hello", "FunctionDeviceSupportData Not");
                Logger.t(TAG).i(message);
                //  sendMsg(message, 2);
...
//                poID = mDatabase.push().getKey();
    ...
    private void TTS(final String data) {
        tts = new TextToSpeech(OutdoorCyclingActivity.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        try {
            ...
            if (!returnValue.isEmpty()) {
                ...
                if (extension.equals("mp4") | extension.equals("mkv")) {
                    camera_file = "0";
                    Toast.makeText(OutdoorCyclingActivity.this, "Please use a image , not a video.", Toast.LENGTH_LONG).show();
                }
