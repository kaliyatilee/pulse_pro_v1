...
public class OutdoorWalkingActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationManagerInterface, IBleWriteResponse {
...
//    ImageView camerarun;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outdoorwalking);
...
//                        mapimg.setImageBitmap(ImageUtil.convert(base64String));
        ...
        if (!isActive) {
            ...
            myEdit.putString("Activity Name", "OutdoorWalk");
            myEdit.putString("Activity Time", activityStartTime);
            myEdit.putString("Activity Status", "Ended");
            myEdit.apply();

            isActive = true;
            CM.showProgressLoader(OutdoorWalkingActivity.this);
            new addActivityApi().endActivityApi(userId, timeTaken, String.valueOf(activityDistance), String.valueOf(activityKcals), avarageHeartRate, String.valueOf(activitySteps), avgPace, camera_file, today, "Outdoor Walking", OutdoorWalkingActivity.this,new ActivityCallback() {
                @Override
                public void success() {
                    try {
                        ...
                        db.insertActivities("Outdoor Walking", userId, timeTaken, activitySteps,
    ...
    private void getReadings() {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                VPOperateManager.getMangerInstance(OutdoorWalkingActivity.this).readSportModelState(OutdoorWalkingActivity.this, new ISportModelStateListener() {


                    @Override
                    public void onSportModelStateChange(SportModelStateData sportModelStateData) {
                        Log.e("Activity modeeeeeeee", String.valueOf(sportModelStateData.getSportModeType()));
...
//                poID = mDatabase.push().getKey();
    ...
    private void TTS(final String data) {
        tts = new TextToSpeech(OutdoorWalkingActivity.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        try {
            ...
            if (!returnValue.isEmpty()) {
                ...
                if (extension.equals("mp4") | extension.equals("mkv")) {
                    camera_file = "0";
                    Toast.makeText(OutdoorWalkingActivity.this, "Please use a image , not a video.", Toast.LENGTH_LONG).show();
                }
