...
public class IndoorWalkActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationManagerInterface, IBleWriteResponse {
...
//    ImageView camerarun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indoor_walk);
...
//                        mapimg.setImageBitmap(ImageUtil.convert(base64String));
        ...
        if (!isActive) {
            ...
            myEdit.putString("Activity Name", "IndoorWalk");
            ...
            new addActivityApi().endActivityApi(userId, timeTaken, String.valueOf(activityDistance), String.valueOf(activityKcals), avarageHeartRate, String.valueOf(activitySteps), avgPace, camera_file, today, "Indoor Walking",IndoorWalkActivity.this, new ActivityCallback() {
                @Override
                public void success() {
                    try {
                        CM.HideProgressLoader();
                        db.insertActivities("Indoor Walking", userId, timeTaken, activitySteps,
                        ...
                        intent.putExtra("activity", "Indoor Walking");
    ...
    private void getReadings() {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                VPOperateManager.getMangerInstance(IndoorWalkActivity.this).readSportModelState(IndoorWalkActivity.this, new ISportModelStateListener() {
...
//                poID = mDatabase.push().getKey();
    ...
    private void TTS(final String data) {
        tts = new TextToSpeech(IndoorWalkActivity.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        try {
            ...
            if (!returnValue.isEmpty()) {
                ...
                if (extension.equals("mp4") | extension.equals("mkv")) {
                    camera_file = "0";
                    Toast.makeText(IndoorWalkActivity.this, "Please use a image , not a video.", Toast.LENGTH_LONG).show();
                }
