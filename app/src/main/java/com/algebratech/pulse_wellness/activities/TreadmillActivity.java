...
import com.algebratech.pulse_wellness.db.DatabaseHelper;
...
public class TreadmillActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationManagerInterface, IBleWriteResponse {
...
//                        mapimg.setImageBitmap(ImageUtil.convert(base64String));
        ...
        if (!isActive) {
            ...
            myEdit.putString("Activity Name", "Treadmill");
            ...
            new addActivityApi().endActivityApi(userId, timeTaken, String.valueOf(activityDistance), String.valueOf(activityKcals), avarageHeartRate, String.valueOf(activitySteps), avgPace, camera_file, today, "Treadmill", TreadmillActivity.this,new ActivityCallback() {
                @Override
                public void success() {
                    try {
                        ...
                        db.insertActivities("Treadmill", userId, timeTaken, activitySteps,
    ...
    private void getReadings() {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                VPOperateManager.getMangerInstance(TreadmillActivity.this).readSportModelState(TreadmillActivity.this, new ISportModelStateListener() {
...
//                poID = mDatabase.push().getKey();
    ...
    private void TTS(final String data) {
        tts = new TextToSpeech(TreadmillActivity.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        try {
            ...
            if (!returnValue.isEmpty()) {
                ...
                if (extension.equals("mp4") | extension.equals("mkv")) {
                    camera_file = "0";
                    Toast.makeText(TreadmillActivity.this, "Please use a image , not a video.", Toast.LENGTH_LONG).show();
                }
