...
public class StairStepperActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationManagerInterface, IBleWriteResponse {
...
//    ImageView camerarun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stair_stepper);
...
//                        mapimg.setImageBitmap(ImageUtil.convert(base64String));
        ...
        if (!isActive) {
            ...
            myEdit.putString("Activity Name", "StairStepper");
            ...
            new addActivityApi().endActivityApi(userId, timeTaken, String.valueOf(activityDistance), String.valueOf(activityKcals), avarageHeartRate, String.valueOf(activitySteps), avgPace, camera_file, today, "Stair Stepper", StairStepperActivity.this,new ActivityCallback() {
                @Override
                public void success() {
                    try {
                        CM.HideProgressLoader();
                        db.insertActivities("Stair Stepper", userId, timeTaken, activitySteps,
    ...
    private void getReadings() {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                VPOperateManager.getMangerInstance(StairStepperActivity.this).readSportModelState(StairStepperActivity.this, new ISportModelStateListener() {
...
//                poID = mDatabase.push().getKey();
    ...
    private void TTS(final String data) {
        tts = new TextToSpeech(StairStepperActivity.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        try {
            ...
            if (!returnValue.isEmpty()) {
                ...
                if (extension.equals("mp4") | extension.equals("mkv")) {
                    camera_file = "0";
                    Toast.makeText(StairStepperActivity.this, "Please use a image , not a video.", Toast.LENGTH_LONG).show();
                }
