...
public class IndoorRunActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, LocationManagerInterface, IBleWriteResponse {
    ...
    private void getReadings() {
        ...
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                VPOperateManager.getMangerInstance(IndoorRunActivity.this).readSportModelState(IndoorRunActivity.this, new ISportModelStateListener() {
...
//                poID = mDatabase.push().getKey();
    ...
    private void TTS(final String data) {
        tts = new TextToSpeech(IndoorRunActivity.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        try {
            ...
            if (!returnValue.isEmpty()) {
                ...
                if (extension.equals("mp4") | extension.equals("mkv")) {
                    camera_file = "0";
                    Toast.makeText(IndoorRunActivity.this, "Please use a image , not a video.", Toast.LENGTH_LONG).show();
                }
...
//                        mapimg.setImageBitmap(ImageUtil.convert(base64String));
        ...
        if (!isActive) {
            ...
            myEdit.putString("Activity Name", "IndoorRun");
            ...
            new addActivityApi().endActivityApi(userId, timeTaken, String.valueOf(activityDistance), String.valueOf(activityKcals), avarageHeartRate, String.valueOf(activitySteps), avgPace, camera_file, today, "Indoor Running",IndoorRunActivity.this, new ActivityCallback() {
                @Override
                public void success() {
                    try {
                        CM.HideProgressLoader();

                        db.insertActivities("Indoor Running", userId, timeTaken, activitySteps,
                        ...
                        intent.putExtra("activity", "Indoor Running");
