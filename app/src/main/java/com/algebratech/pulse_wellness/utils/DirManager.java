...
public class DirManager {
    ...
    private static final String APP_FOLDER_NAME = Constants.PREF_NAME;
    ...
    public static String mainAppFolder() {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            file = new File(App.context().getExternalFilesDir(null) + "/" + APP_FOLDER_NAME + "/");
        } else {
    ...
    public static String getSentImagesFolder() {
        File file = new File(mainAppFolder() + "/"  + "Images/Sent");
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static String getUserProfilePhotoFolder() {
        File file = new File(mainAppFolder() + "/"  + "Profile Photos");
        if (!file.exists()) {
            file.mkdirs();
        }
        createNoMediaFile(file);
    ...
    public static String getReceivedFilesFolder() {
        File file = new File(mainAppFolder() + "/"  + "Files");
        if (!file.exists())
            file.mkdirs();
    ...
    public static String getSentFilesFolder() {
        File file = new File(mainAppFolder() + "/"  + "Files/Sent");
        if (!file.exists())
            file.mkdirs();
    ...
    public static String getSentAudioFolder() {
        File file = new File(mainAppFolder() + "/"  + "Audio/Sent");
        if (!file.exists()) {
            file.mkdirs();
        }
        createNoMediaFile(file);
    ...
    public static String getReceivedAudioFolder() {
        File file = new File(mainAppFolder() + "/"  + "Audio");
        if (!file.exists())
            file.mkdirs();
    ...
    public static String sentVoiceMessageDir() {
        File file = new File(mainAppFolder() + "/"  + "VoiceMessage/Sent/");
        if (!file.exists()) {
            file.mkdirs();
        }
        createNoMediaFile(file);
    ...
    public static String voiceMessagesReceived() {
        File file = new File(mainAppFolder() + "/"  + "VoiceMessage");
        if (!file.exists())
            file.mkdirs();
    ...
    public static String shareSocial() {
        File file = new File(mainAppFolder() + "/"  + "Activities");
        if (!file.exists())
            file.mkdirs();
    ...
    public static String receivedVideoDir() {
        File file = new File(mainAppFolder() + "/"  + "Video/");
        if (!file.exists())
            file.mkdirs();
    ...
    public static String sentVideoDir() {
        File file = new File(mainAppFolder() + "/"  + "Video/Sent");
        if (!file.exists()) {
            file.mkdirs();
        }
        createNoMediaFile(file);
    ...
    public static File generateFile(int type) {
        ...
        switch (type) {
            ...
            case MessageType.SHARE_SOCIAL:
                file = new File(shareSocial() + "/" + generateNewName(type) + EXTENSION_JPG);
                break;
